...
void RenderScene(int per_vertex_or_per_pixel) {
	...
	glUniform3f(iLocLightInfo.position, lightInfo.position.x, lightInfo.position.y, lightInfo.position.z);
	glUniform3f(iLocLightInfo.Ld, lightInfo.diffuse.x, lightInfo.diffuse.y, lightInfo.diffuse.z);
	glUniform3f(iLocLightInfo.La, lightInfo.ambient.x, lightInfo.ambient.y, lightInfo.ambient.z);
	glUniform3f(iLocLightInfo.Ls, lightInfo.specular.x, lightInfo.specular.y, lightInfo.specular.z);
	glUniform1f(iLocLightInfo.shininess, lightInfo.shininess);
...
void initParameter()
{
	...
	lightInfo.position = Vector3(1.0f, 1.0f, 1.0f);
	lightInfo.diffuse = Vector3(1.0f, 1.0f, 1.0f);
	lightInfo.ambient = Vector3(0.15f, 0.15f, 0.15f);
	lightInfo.shininess = 64.0f;
	lightInfo.specular = Vector3(1.0f, 1.0f, 1.0f);
}
...
void setUniformVariables()
{
	...
	iLocLightInfo.position = glGetUniformLocation(program, "light.position");
	iLocLightInfo.La = glGetUniformLocation(program, "light.La");
	iLocLightInfo.Ld = glGetUniformLocation(program, "light.Ld");
	iLocLightInfo.Ls = glGetUniformLocation(program, "light.Ls");
	iLocLightInfo.spotDirect = glGetUniformLocation(program, "light.spotDirect");
	iLocLightInfo.spotCutoff = glGetUniformLocation(program, "light.spotCutoff");
	iLocLightInfo.spotExponent = glGetUniformLocation(program, "light.spotExponent");
	iLocLightInfo.shininess = glGetUniformLocation(program, "light.shininess");
